...
function MyWinbar()
  ...
  if actual_curwin == curwin then
    return '%#WinBarActive#%#WinBarTextActive#' .. ' ' .. buffer_name .. '%m%r%#WinBarActive#%=%#WinBarActiveMuted#'
             .. text_settings
  else
    return '%#WinBarInactive#%#WinBarTextInactive#' .. ' ' .. buffer_name
             .. '%m%r%#WinBarInactive#%=%#WinBarInactiveMuted#' .. text_settings
  end
end
