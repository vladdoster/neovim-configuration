...
_G.packer_plugins = {
  LuaSnip = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/vd71/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  ["nvim-compe"] = {
    after_files = { "/home/vd71/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    config = { "require('configs.compe')" },
    loaded = false,
    needs_bufread = false,
    path = "/home/vd71/.local/share/nvim/site/pack/packer/opt/nvim-compe",
    wants = { "LuaSnip" }
  },
  ["nvim-lspconfig"] = {
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'nvim-bufferline.lua', 'galaxyline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
