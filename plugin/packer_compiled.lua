...
_G.packer_plugins = {
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/Users/e109082/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim"
  },
  ["lspkind-nvim"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspkind-nvim', 'nvim-lspinstall'}, { event = "BufRead *" }, _G.packer_plugins)]]
