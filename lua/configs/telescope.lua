...
local actions, previewers, sorters = require 'telescope.actions', require 'telescope.previewers', require 'telescope.sorters'
M.common_keymaps = {
...
M.mergeMaps = function(keymaps)
  local c = {}
  for k, v in pairs(M.common_keymaps) do
    c[k] = v
  end
...
for _, x in pairs { 'fzf', 'notify', 'project', 'terraform_doc' } do
