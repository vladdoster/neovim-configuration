...
return {
  {
    ...
    build = ":MasonUpdate",
    dependencies = {
      "williamboman/mason-lspconfig.nvim", 'folke/neodev.nvim', "neovim/nvim-lspconfig"
    },
  ...
  }, {'onsails/lspkind-nvim', config = function() require "extensions.lspkind" end},
  {'nvim-lualine/lualine.nvim', config = function() require "extensions.lualine" end},
  {'lewis6991/gitsigns.nvim', config = function() require "extensions.gitsigns" end},
  {"folke/trouble.nvim", dependencies = {"kyazdani42/nvim-web-devicons"}}, {
    ...
    config = function()
      ...
      require("dial.config").augends:register_group({
        default = {
          augend.constant.alias.bool, augend.integer.alias.decimal, augend.semver.alias.semver
        }
      })
    end,
    keys = {
      {"<C-a>", expr = true, function() return require("dial.map").inc_normal() end},
      {"<C-x>", expr = true, function() return require("dial.map").dec_normal() end}
    }
  }, {
    "echasnovski/mini.surround",
    opts = {mappings = {add = "gsa", delete = "gsd", replace = "gsr", update_n_lines = "gsn"}}
  }, {'akinsho/toggleterm.nvim', cmd = {'TermExec', 'ToggleTerm'}, opts = {}},
  {'junegunn/vim-easy-align', cmd = 'EasyAlign', lazy = true}, {'numToStr/Comment.nvim', opts = {}},
  {
    ...
    lazy = true
  }, {'sQVe/sort.nvim', cmd = 'Sort'}, {"kylechui/nvim-surround", opts = {}}, {
