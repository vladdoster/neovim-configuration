...
--- expose luajit runtime files discoverable to the server
...
--- expose neovim runtime files discoverable to the server
function U.get_nvim_rtp_path() return {os.getenv('VIMRUNTIME')} end
return U
