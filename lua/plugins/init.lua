...
return packer.startup(function()
    ...
    use {'kyazdani42/nvim-tree.lua', cmd = {'NvimTreeToggle', 'NvimTreeFocus'}, config = [[require "plugins.nvimtree"]]}
    -- LSP
    ...
    use {'ray-x/lsp_signature.nvim', after = 'nvim-lspconfig', config = [[require("plugins.others").signature()]]}
    use {'folke/trouble.nvim', cmd = 'Trouble', config = [[require("trouble").setup()]]}
    ...
    use {
        ...
        cmd = 'Telescope',
        requires = {{'nvim-telescope/telescope-fzf-native.nvim', 'nvim-lua/plenary.nvim', run = 'make -j'}},
    ...
    use {'TimUntersberger/neogit', cmd = {'Neogit', 'Neogit commit'}, config = [[require 'plugins.neogit']]}
    use {'michaelb/sniprun', run = 'bash ./install.sh', cmd = 'SnipRun', config = [[require'sniprun'.setup()]]}
end)
