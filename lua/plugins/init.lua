    ...
    function()
        ...
        use {
            ...
            requires = {
                ...
                {'lukas-reineke/cmp-under-comparator'}, {'f3fora/cmp-spell'}, {'hrsh7th/cmp-buffer'},
                {'hrsh7th/cmp-nvim-lsp'}, {'hrsh7th/cmp-nvim-lua'}, {'hrsh7th/cmp-path'}, {'hrsh7th/cmp-vsnip'},
                {'onsails/lspkind-nvim'}, {'rafamadriz/friendly-snippets'}, {'ray-x/cmp-treesitter'},
        ...
        use {
            ...
            module = 'telescope',
            requires = {
                {'nvim-telescope/telescope-fzf-native.nvim', run = 'make'}, {'nvim-lua/popup.nvim'},
